...
#    Updated: 2021/11/14 21:28:28 by mrahmani         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME	 	= minishell

SRCS		= main.c check.c parsing.c pipe.c pwd.c free.c parse.c mini_split.c cd.c  echo.c env.c export.c unset.c ctrl_c.c
